...
func newAuth(db *gorm.DB, opts ...gen.DOOption) auth {
	...
	_auth.ID = field.NewUint32(tableName, "id")
	_auth.Account = field.NewString(tableName, "account")
	_auth.NickName = field.NewString(tableName, "nick_name")
...
func (a *auth) WithContext(ctx context.Context) *authDo { return a.authDo.WithContext(ctx) }
