...
func newConversationMember(db *gorm.DB, opts ...gen.DOOption) conversationMember {
	...
	_conversationMember.ConvID = field.NewUint64(tableName, "conv_id")
	_conversationMember.UserID = field.NewUint32(tableName, "user_id")
	_conversationMember.Role = field.NewInt8(tableName, "role")
	_conversationMember.LastReadSeq = field.NewUint64(tableName, "last_read_seq")
	_conversationMember.CreatedAt = field.NewTime(tableName, "created_at")
	_conversationMember.UpdatedAt = field.NewTime(tableName, "updated_at")
	_conversationMember.DeletedAt = field.NewField(tableName, "deleted_at")
...
type conversationMember struct {
	...
	Role        field.Int8   // 1-成员，2-管理员
	LastReadSeq field.Uint64 // 最后读到的会话内序号
...
func (c *conversationMember) updateTableName(table string) *conversationMember {
	...
	c.LastReadSeq = field.NewUint64(table, "last_read_seq")
...
func (c *conversationMember) fillFieldMap() {
	...
	c.fieldMap["last_read_seq"] = c.LastReadSeq
