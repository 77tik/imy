...
func newConversation(db *gorm.DB, opts ...gen.DOOption) conversation {
	...
	_conversation.Type = field.NewInt8(tableName, "type")
	_conversation.Remark = field.NewString(tableName, "remark")
	_conversation.PairKey = field.NewString(tableName, "pair_key")
...
type conversation struct {
	...
	ALL       field.Asterisk
	ID        field.Uint64 // 会话id，雪花id
	Type      field.Int8   // 1-单聊,2-群聊
	Remark    field.String // 备注
	PairKey   field.String // 单聊配对唯一键，群聊为null,解决并发竞争
...
func (c *conversation) updateTableName(table string) *conversation {
	...
	c.PairKey = field.NewString(table, "pair_key")
