...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.FileName = field.NewString(tableName, "file_name")
	_user.Abstract = field.NewString(tableName, "abstract")
	_user.Phone = field.NewString(tableName, "phone")
	_user.Status = field.NewInt8(tableName, "status")
	_user.Gender = field.NewInt8(tableName, "gender")
	_user.LastLoginIP = field.NewString(tableName, "last_login_ip")
	_user.Source = field.NewInt8(tableName, "source")
...
type user struct {
	...
	UUID        field.String // 用户ID
	NickName    field.String // 用户昵称
	Password    field.String // 加密后的密码
	Email       field.String // 邮箱
	FileName    field.String // 头像文件路径
	Abstract    field.String // 个性签名
	Phone       field.String // 手机号
	Status      field.Int8   // 1表示正常，2表示禁用
	Gender      field.Int8   // 1男，2女，3未知
	LastLoginIP field.String // 最后一次登陆的ip地址
	Source      field.Int8   // 注册来源
...
func (u *user) updateTableName(table string) *user {
	...
	u.Abstract = field.NewString(table, "abstract")
	...
	u.Source = field.NewInt8(table, "source")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["abstract"] = u.Abstract
